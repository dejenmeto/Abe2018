...
async function createEmployee(employee) {
  ...
  try {
    ...
    createdEmployee = {
      employee_id: employee_id, //the second is autho generated
    };
  } catch (err) {
    console.log(err);
  }
...
// A function to get employee by email for loginnnn check from earlier employee for authorization and authentication purposes.
// This function is used to get the employee by email for login check from earlier employee for authorization and authentication purposes.
