...
import image1 from "../../assets/template-assets/images/custom/misc/vban1.jpg";
import image2 from "../../assets/template-assets/images/custom/misc/vban2.jpg";
import image3 from "../../assets/template-assets/images/resource/image-3.jpg";
import image4 from "../../assets/template-assets/images/resource/image-4.jpg";
import banner from "../../assets/template-assets/images/background/bg-1.jpg";
function Home() {
  return (
    <>
      <section className="video-section">
        ...
        <div className="auto-container">
          <h5>Working since 2016</h5>
          <h2>
            Grow up Your Car <br /> to Next Level
          </h2>
          ...
          <div className="row">
            ...
            <div className="col-lg-7 pl-lg-5">
              <div className="sec-title">
                ...
                <h2>We have 13 years experience</h2>
                <div className="text">
                  <p>
